...
public class Constants {
	...
	public final static double SHOOTER_BANG_SPEED = 0.50;	//When you adjust this you also have to change range
	public final static int SHOOTER_BANG_RANGE = 4369;	//Calculated by old_range(new_speed / old_speed)
